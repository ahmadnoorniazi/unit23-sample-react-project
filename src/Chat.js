  ...
  logedOut() {
    ...
    return(
      <div>
        ...
        <form className="log-out" onSubmit={this.logedOut}>
          <input type="submit" value="log out"/>
        </form>
        </div>
        <Messages datas={this.props.data}/>
        <input className="message-field" type="text" value={this.props.messages} onKeyPress={this.submit} onChange={this.props.handleMessege} placeholder="Type your messege and hit ENTER"/> 
      </div>
      );
  }
}
